...
#endif
#endregion
public class RA_SplineI : MonoBehaviour{
	#if UNITY_EDITOR
	public class RA_SplineIN{
		public Vector3 pos;
	...
	public int tCount = 0;
	public List<RA_SplineIN> mNodes = new List<RA_SplineIN> ();
	public bool bClosed = false;
	public float distance = -1f;
	public Vector3 MousePos = new Vector3(0f,0f,0f);
	public RA_SplineC RA_Spline;
	public RA_SplineIN ActionNode;
	
	public void DetermineInsertNodes(){
		int iCount = RA_Spline.mNodes.Count;
		if(iCount < 2){ return; }
		RA_SplineIN tNode;
		RA_SplineN xNode;
		mNodes.Clear();
		float tParam = RA_Spline.GetClosestParam(MousePos,false,true);
		...
		for(int i=0;i<iCount;i++){
			xNode = RA_Spline.mNodes[i];
			tNode = new RA_SplineIN();
			tNode.pos = xNode.pos;
	...
	private int CompareListByName(RA_SplineIN i1, RA_SplineIN i2){
